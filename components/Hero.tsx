...
const Hero = () => {
  return (
    <section className="bg-primary text-white h-[555px]  md:h-[555px]  flex flex-col md:flex-row  justify-center pt-24 space-y-4 md:space-y-0md:px-10 md:space-x-8 px-4 md:px-10 py-10">
      <div className=" flex-col mt-14  md:items-start md:text-left max-w-md md:max-w-none md:mt-14 ">
        <h1 className="text-[43px] font-bold mb-4 md:text-[43px]">
          Get More Done with <br /> Whitepace
        </h1>
      ...
      <div className="bg-[#C4DEFD] text-black h-[200px] md:h-[345px] w-full md:w-[540px] flex justify-center  items-center shadow-lg md:mt-24">
      </div>
    </section>
  );
};
